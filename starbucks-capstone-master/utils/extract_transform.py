...
def loadAndCleanPortfolio():
  ...
  portfolio = pd.read_json("starbucks-capstone-master/portfolio.json", orient='records', lines=True)
...
def loadAndCleanProfile(return_raw=False):
  ...
  profile = pd.read_json('starbucks-capstone-master/profile.json', orient='records', lines=True)
...
def loadAndCleanTranscript():
  ...
  transcript = pd.read_json('starbucks-capstone-master/transcript.json', orient='records', lines=True)
